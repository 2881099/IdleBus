...
> FluentScheduler 如果在一个 Registry 测试是正常的，但看上去应该是单线程执行(间隔10-100ms)，处理速度不理想

[View Code](https://github.com/2881099/IdleBus/blob/master/Examples/Examples_IdleScheduler_VsQuartz/Program.cs)
